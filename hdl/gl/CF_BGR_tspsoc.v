...
module CF_BGR_tspsoc (Vout, ibg_2p375uA, mux1out, dft_sel, mux1sel, CurrAbsTrim, iptat, dft_curr_in, ibg_3uA, trimTC, ictat, pbias_ctat, mux2out, trimCurr, vout_ictat, inl_ctrl, pd, vbias_cascode, pd_ibg, mux2sel, vbias, vgnd, vpwr, vpb, vnb);
    output Vout;
		output ictat;
		output iptat;
    output ibg_2p375uA;
